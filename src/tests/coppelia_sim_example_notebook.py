...
pr.launch('/home/petr/my_ws/src/coppelia_sim_ros_interface/include/scenes/scene_panda_franka_gripper.ttt', headless=False, responsive_ui=True)
...
''' (1) Test of setting positions without dynamics '''
from pyrep.objects.shape import Shape
